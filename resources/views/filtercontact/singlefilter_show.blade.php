...
<html lang="en">
  ...
  <body>
                        ...
                        @foreach($phonebooklist as $key=>$phonebook)
                            <div class="contact">
                                <div class="person-details" onclick="showNumber('phone-{{$key}}')">
                                    ...
                                    <p><span>{{$phonebook->person->email}}</span></p>
                                </div>
                                <div class="number-list" id="phone-{{$key}}">
                                    <div class="phonebook">
                                        ...
                                        <div class="action">
                                                <a href="{{route('contact.delete',$phonebook->person->id)}}" class="btn-danger btn-sm btn"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                <a  href="{{route('contact.edit',$phonebook->person->id)}}" class="btn-success btn-sm btn"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function filterShow() {
            document.getElementById("filterItems").classList.toggle("show");
            }
