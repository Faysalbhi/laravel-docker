                    ...
                    <div class="card-header">
                        <h3>Contact List</h3>
                            ...
                            <div class="dropdown">
                                ...
                                <form action="{{route('multi.filterContact')}}" method="get">
                                    @csrf
                                    <div id="filterItems" class="dropdown-content">
                                        <input type="checkbox" id="home" name="type[]" {{in_array('Home', $data['type']) ? 'checked' : ''}} value="Home">
                                        <label for="home"> Home</label><br>
                                        <input type="checkbox" id="personal" name="type[]" value="Personal" {{in_array('Personal', $data['type']) ? 'checked' : ''}}>
                                        <label for="personal">Personal</label><br>
                                        <input type="checkbox" id="office" name="type[]" {{in_array('Office', $data['type']) ? 'checked' : ''}} value="Office">
                            ...
                            @php
                                $data['excel']=true;
                            @endphp
                            <a class="btn btn-info btn-sm" href="{{route('multi.filterContact', $data)}}">Download</a>
                    </div>
